...
{
    /// <inheritdoc />
    public partial class InitialMigrationWithCorrectedUserTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Support message created on date"),
                    HandledOn = table.Column<DateTime>(type: "datetime2", nullable: false, comment: "Support message handled on date"),
                    IsHandled = table.Column<bool>(type: "bit", nullable: false, comment: "Support message completed on date"),
                    ApplicationUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false, comment: "Support message user fk"),
                    HandledByAdminUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true, comment: "Support message handled by admin user")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupportMessages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupportMessages_AdminUsers_HandledByAdminUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupportMessages_HandledByAdminUserId",
                table: "SupportMessages",
